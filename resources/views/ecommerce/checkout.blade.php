...
@section('title')
<title>Checkout - Halimah Online Shop</title>
@endsection
                ...
                <div class="col-lg-8">
                    ...
                    <form class="row contact_form" action="{{ route('front.store_checkout') }}" method="post"
                        ...
                        <div class="col-md-6 form-group p_star">
                            ...
                            <input type="email" class="form-control" id="email" name="email" value="{{ auth()->guard('customer')->user() ? auth()->guard('customer')->user()->email : "" }}" required {{ auth()->guard('customer')->check() ? 'readonly':'' }}>
